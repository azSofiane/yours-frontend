...
function Annonce({ id, props }) {
  ...
  const saveAnnonceClick = () => {
    if(!user.token) return;
		...
		fetch('https://yours-backend.vercel.app/annonces/edit/' + id, {
      method: 'PUT',
  ...
  const postulerEleveAnnonce = () => {
    ...
    fetch('https://yours-backend.vercel.app/eleves/postuler/' + id + '/' + user.token, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
  ...
  const mettreAnnonceEnFavori = () => {
    fetch('https://yours-backend.vercel.app/eleves/favoris/' + id + '/' + user.token, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
    }).then(response => response.json())
      .then(data => {
  ...
  const postulerChoix = (status, tokenEleve) => {
    ...
    fetch('https://yours-backend.vercel.app/professionnels/postuler/' + id + '/' + user.token, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
