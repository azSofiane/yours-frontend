...
function Home() {
  ...
  const handleConnection = () => {
    fetch('https://yours-backend.vercel.app/connexion/', {
      method: 'POST',
  ...
  const handleSignup = () => {
    ...
    fetch('https://yours-backend.vercel.app/inscription', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const handleMot_de_passeOublie = () => {
    ...
    fetch('https://yours-backend.vercel.app/reinisialisermdp/forgot-password', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  fetch('https://yours-backend.vercel.app/reinisialisermdp/reset-password', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(requestData),
    }).then(response => response.json())
